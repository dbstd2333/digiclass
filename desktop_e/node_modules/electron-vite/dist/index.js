...
var config = require('./chunks/lib-ddb42891.js');
var server = require('./chunks/lib-b694cd80.js');
var build = require('./chunks/lib-4ba04c01.js');
var preview = require('./chunks/lib-6f6a53df.js');
        ...
        closeBundle() {
            if (!useInRenderer) {
                ...
                bytecodeFiles.forEach(file => {
                    ...
                    config.logger.info(`${colors__default["default"].gray(colors__default["default"].white(colors__default["default"].dim(outDir)))}${colors__default["default"].green(file.name.padEnd(longest + 2))} ${kbs > chunkLimit ? colors__default["default"].yellow(`${kbs.toFixed(2)} kB`) : colors__default["default"].dim(`${kbs.toFixed(2)} kB`)}`);
                });
                bytecodeFiles = [];
            }
        }
